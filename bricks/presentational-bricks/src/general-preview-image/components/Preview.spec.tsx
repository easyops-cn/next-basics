...
jest.mock("./Preview", () => {
  const MockPreview = (props: any) => {
    ...
    let Preview = jest.requireActual("./Preview");
...
describe("Preview", () => {
  ...
  it("Show preview and close", () => {
    ...
    fireEvent.click(
      document.querySelector(".rc-image-preview-operations-operation")
    );
  ...
  it("Rotate", () => {
    ...
    fireEvent.click(
      document.querySelectorAll(".rc-image-preview-operations-operation")[3]
    );
    act(() => {
      jest.runAllTimers();
    });
    expect(
      document
        .querySelector(".rc-image-preview-img")
        .style.getPropertyValue("transform")
    ).toEqual("translate3d(0px, 0px, 0) scale3d(1, 1, 1) rotate(90deg)");

    fireEvent.click(
      document.querySelectorAll(".rc-image-preview-operations-operation")[4]
    );
    act(() => {
      jest.runAllTimers();
    });
    expect(
      document
        .querySelector(".rc-image-preview-img")
        .style.getPropertyValue("transform")
    ).toEqual("translate3d(0px, 0px, 0) scale3d(1, 1, 1) rotate(0deg)");
  });
  ...
  it("Flip", () => {
    ...
    fireEvent.click(
      document.querySelectorAll(".rc-image-preview-operations-operation")[5]
    );
    act(() => {
      jest.runAllTimers();
    });
    ...
    fireEvent.click(
      document.querySelectorAll(".rc-image-preview-operations-operation")[6]
    );
    act(() => {
      jest.runAllTimers();
    });
  ...
  it("Scale", () => {
    ...
    fireEvent.click(
      document.querySelectorAll(".rc-image-preview-operations-operation")[2]
    );
    act(() => {
      jest.runAllTimers();
    });
    ...
    fireEvent.click(
      document.querySelectorAll(".rc-image-preview-operations-operation")[1]
    );
    act(() => {
      jest.runAllTimers();
    });
    expect(
      ...
      "translate3d(-256px, -192px, 0) scale3d(1.5, 1.5, 1) rotate(0deg)"
    );
    ...
    expect(
      document
        .querySelector(".rc-image-preview-img")
        .style.getPropertyValue("transform")
    ).toEqual("translate3d(0px, 0px, 0) scale3d(1.25, 1.25, 1) rotate(0deg)");
    ...
    expect(
      document
        .querySelector(".rc-image-preview-img")
        .style.getPropertyValue("transform")
    ).toEqual("translate3d(0px, 0px, 0) scale3d(50, 50, 1) rotate(0deg)");
  });
  ...
  it("scaleStep = 1", () => {
    ...
    expect(
      document
        .querySelector(".rc-image-preview-img")
        .style.getPropertyValue("transform")
    ).toEqual("translate3d(-512px, -384px, 0) scale3d(2, 2, 1) rotate(0deg)");
    ...
    expect(
      document
        .querySelector(".rc-image-preview-img")
        .style.getPropertyValue("transform")
    ).toEqual("translate3d(0px, 0px, 0) scale3d(1.5, 1.5, 1) rotate(0deg)");
  ...
  it("Reset position on double click", () => {
    ...
    fireMouseEvent(
      "mouseDown",
      document.querySelector(".rc-image-preview-img"),
      {
        pageX: 0,
        pageY: 0,
        button: 0,
    ...
    expect(
      document
        .querySelector(".rc-image-preview-img")
        .style.getPropertyValue("transform")
    ).toEqual("translate3d(50px, 50px, 0) scale3d(1, 1, 1) rotate(0deg)");
    ...
    expect(
      document
        .querySelector(".rc-image-preview-img")
        .style.getPropertyValue("transform")
    ).toEqual("translate3d(75px, 75px, 0) scale3d(1.5, 1.5, 1) rotate(0deg)");
  });
  ...
  it("Mouse Event", () => {
    ...
    expect(
      document
        .querySelector(".rc-image-preview-img")
        .style.getPropertyValue("transform")
    ).toEqual("translate3d(460px, 116px, 0) scale3d(1, 1, 1) rotate(0deg)");
    ...
    expect(
      document
        .querySelector(".rc-image-preview-img")
        .style.getPropertyValue("transform")
    ).toEqual("translate3d(-60px, -84px, 0) scale3d(1, 1, 1) rotate(0deg)");
    ...
    expect(
      document
        .querySelector(".rc-image-preview-img")
        .style.getPropertyValue("transform")
    ).toEqual("translate3d(-40px, -66px, 0) scale3d(1, 1, 1) rotate(0deg)");
    ...
    expect(
      ...
      "translate3d(-85px, -65px, 0) scale3d(1.25, 1.25, 1) rotate(0deg)"
    );
  ...
  it("preview placeholder", () => {
    ...
    expect(document.querySelector(".rc-image-mask").textContent).toEqual(
      "Bamboo Is Light"
    );
    expect(
      document.querySelector(".rc-image-mask").classList.contains("bamboo")
    ).toBeTruthy();
  });
  ...
  it("previewSrc", () => {
    ...
    const { container } = render(
      <Image src={src} preview={{ src: previewSrc }} />
    );

    expect(
      container.querySelector(".rc-image-img").getAttribute("src")
    ).toEqual(src);
    ...
    expect(document.querySelector(".rc-image-preview")).toBeTruthy();
    expect(
      document.querySelector(".rc-image-preview-img").getAttribute("src")
    ).toEqual(previewSrc);
  });
  ...
  it("add rootClassName should be correct", () => {
    ...
    const { container, asFragment } = render(
      <Image src={src} rootClassName="custom-className" />
    );
  ...
  it("add rootClassName should be correct when open preview", () => {
    ...
    expect(
      container
        .querySelector(".rc-image.custom-className .rc-image-img")
        .getAttribute("src")
    ).toEqual(src);
    expect(
      document.querySelector(".rc-image-preview-root.custom-className")
    ).toBeFalsy();
    ...
    // expect(
    //   document.querySelector('.rc-image-preview-root.custom-className .rc-image-preview-img').getAttribute("src")
    // ).toEqual(previewSrc);
  ...
  it("if async src set should be correct", () => {
    ...
    expect(
      document
        .querySelector(".rc-image-preview-switch-left")
        .classList.contains("rc-image-preview-switch-left-disabled")
    ).toBeTruthy();
  });
});
