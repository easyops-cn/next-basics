...
import styles from "../workbench-context-menu/WorkbenchContextMenu.module.css";
...
export function WorkbenchCommonContextMenu({
  contextMenuStatus,
  menu,
  clipboard,
  onActionClick,
  ...
  const handleCloseMenu = (e: React.MouseEvent): void => {
    e.preventDefault();
    onContextMenuClose();
  };
