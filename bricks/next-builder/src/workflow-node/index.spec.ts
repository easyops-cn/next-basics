...
describe("next-builder.workflow-node", () => {
  it("should create a custom element", () => {
    const element = document.createElement("next-builder.workflow-node") as any;
    ...
    expect(mockSetActive).toBeCalled();
