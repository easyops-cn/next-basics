...
const locale: Locale = {
  ...
  [K.THERE_ARE_NOTICES]: "📢 There are notices!",
  ...
  [K.REGEX_FIELD_MESSAGE]: "{{name}} does not match {{regex}}",
  [K.EDIT_FIELD_NOT_FOUND_MSG]:
    "Field information not found, may have been removed",
  [K.SELECT_WORKFLOW_FIELD_PLACEHOLDER]:
    "Please select the field under this workflow step",
  ...
  [K.USE_FLOW_CONST_VALUE]: "Use const Value",
  [K.USE_FLOW_STEP_FIELD]: "Use the field value of this workflow node object",
  [K.FIXED_VALUE]: "Fixed value",
  [K.DYNAMIC_VALUE]: "Dynamic value",
  [K.WHEN]: "When",
  [K.SEARCH_FIELD]: "Search field",
