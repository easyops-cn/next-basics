...
const locale: Locale = {
  ...
  [K.BRICK_CATEGORY_FORM_INPUT_BASIC]: "Form Input Basic",
  [K.BRICK_CATEGORY_FORM_INPUT_ADVANCED]: "Form Input Advanced",
  [K.BRICK_CATEGORY_FORM_INPUT_BUSINESS]: "Form Input Business",
  [K.BRICK_CATEGORY_INTERACT_BASIC]: "Interact Basic",
  [K.BRICK_CATEGORY_FORM]: "Form",
  [K.BRICK_CATEGORY_TEXT]: "Text",
  [K.BRICK_CATEGORY_CARD_INFO]: "Card Info",
  [K.BRICK_CATEGORY_CARD_STATISTIC]: "Card Statistic",
  [K.BRICK_CATEGORY_DISPLAY_COMPONENT]: "Display Component",
  [K.BRICK_CATEGORY_DATA_TRANSFORM]: "Data Transform",
  [K.BRICK_CATEGORY_CONTAINER_DISPLAY]: "Container Display",
  [K.BRICK_CATEGORY_CONTAINER_LAYOUT]: "Container Layout",
