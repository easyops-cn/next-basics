          ...
          >
            <div className={styles.signupImg}>
              <div style={{ display: "flex", alignItems: "center" }}>
                <img src={loginPng} className={styles.signupImgSize} />
              </div>
            </div>
              ...
              <Card bordered={false}>
                ...
                <Form name="signupForm" form={form} onFinish={onFinish}>
                  ...
                  >
                    <Input
                      prefix={
                        <UserOutlined className={styles.inputPrefixIcon} />
                      }
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        required: true,
                        message: t(K.PLEASE_ENTER_VALID_EMAIL),
                      },
                  ...
                  >
                    <Input
                      prefix={
                        <MailOutlined className={styles.inputPrefixIcon} />
                      }
                      type="email"
                  ...
                  >
                    <Input
                      prefix={
                        <LockOutlined className={styles.inputPrefixIcon} />
                      }
                      type="password"
                          ...
                          rules={[
                            ...
                            },
                            {
                              validator: (_, value) => {
                                ...
                                return Promise.reject(
                                  new Error(
                                    t(K.PLEASE_FILL_IN_VALID_PHONE_NUMBER)
                                  )
                                );
                              },
                            },
