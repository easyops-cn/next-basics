...
describe("forms.dynamic-form-item-v3", () => {
  it("should create a custom element", () => {
    const element = document.createElement("forms.dynamic-form-item-v3");
  ...
  it("method updateOptions should work", () => {
    const element = document.createElement("forms.dynamic-form-item-v3") as any;
    element.upperRef = {
      current: {
        columns: [
          {
