...
export function InternalStateDatePicker(
  ...
  const handleDisabledPastByDate = (date: Moment): boolean => {
    return date && date < moment(disabledPastByDate);
  };
    ...
    <div className={style.pickerWrap}>
      <DatePicker
        ...
        disabledDate={
          ...
          (disabledPastByDate && handleDisabledPastByDate)
        }
...
export function GeneralDatePicker(
  ...
  const { name, formElement, value, picker, disabledPastByDate, ...restProps } =
    props;
  ...
  return (
    <FormItemWrapper {...props}>
      <InternalStateDatePicker
        ...
        picker={picker}
        disabledPastByDate={disabledPastByDate}
      />
    </FormItemWrapper>
  );
}
