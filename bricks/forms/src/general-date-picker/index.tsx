...
export interface GeneralDatePickerElementProps {
  name?: string;
  value?: string;
  placeholder?: string;
  label?: string;
 ...
 * @memo.en
 * > Tips: When used in combination with `general-form`, if a value is assigned to the date picker through values under form, the data type needs to be declared via `valueTypes`. Meanwhile, to make it more convenient to submit the specified time format to the backend, an option to format the date is also provided after declaring the data, separated by `|`. (As shown in the demo above)
 */

export class GeneralDatePickerElement extends FormItemElement  implements GeneralDatePickerElementProps {
  /* =========================== Group: basic =========================== */

  /**
   * @required true
   * @description 日期选择框字段名
   * @description.en Field name of the date picker
   * @group basic
   */
   ...
   * @description.en Initial value of the date picker
   * @group basic
   * @editor input
   * @editorProps {
   ...
   * @description.en Placeholder text of the date picker
   * @group basic
   */
   ...
   * @description.en Field description of the date picker
   * @required false
   * @group formLabel
   */
   ...
   * @description.en Whether to show the time. When it is set to `true`, please also set `format` to `YYYY-MM-DD HH:mm:ss` so that the specific hour, minute and second are also displayed
   * @group ui
   */
  @property({
    type: Boolean,
   ...
   * @description.en Format for the display preview. For detailed configuration, refer to [moment](https://momentjs.com/docs/#/displaying/format/). Note that this is not the data format defined for the backend; for the data format definition for the backend, please refer to the [valueTypes](developers/brick-book/brick/forms.general-form) property of the `general-form` brick
   * @group ui
   */
  @property({
    attribute: false,
  ...
  /**
   * @description 设置选择器类型
   * @description.en Set the picker type
   * @editor radio
   * @editorProps {
   *   "optionType": "button",
   *   "options": [
   ...
   * @description.en Future dates cannot be selected, with higher priority than disabledDate
   * @group advanced
   */
  @property({ type: Boolean })
  ...
  /**
   * @description 不可选择的日期
   * @description.en Dates that cannot be selected
   * @group advanced
   */
  @property({ attribute: false })
   ...
   * @description.en Dates before the specified date cannot be selected
   * @group advanced
   */
  @property({ attribute: false })
   ...
   * @description.en Dates after the specified date cannot be selected
   * @group advanced
   */
  @property({ attribute: false })
  ...
  /**
   * @description 	日期变化时触发
   * @description.en Triggered when the date changes
   */
   ...
   * @description.en Triggered when the OK button is clicked (used when showTime is true)
   */
   ...
   * @description.en Callback for opening and closing the calendar
   * @param open 是否打开日历
   */
