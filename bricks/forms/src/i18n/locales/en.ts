...
const locale: Locale = {
  ...
  [K.ATTRIBUTE_CATEGORY]: "Attribute Category",
  [K.PLEASE_INPUT_ATTRIBUTE_CATEGORY]: "Please input attribute category",
  [K.REQUIRED]: "Required",
  [K.READONLY]: "Readonly",
  [K.UNIQUE]: "Unique",
  [K.PLEASE_INPUT_ATTRIBUTE_NAME]: "Please input attribute name",
  [K.LIMIT]: "Limit",
  [K.REGULAR]: "Regex Validation:",
  [K.FORMAT]: "Format:",
  [K.CLICK_TO_SELECT_DATE]: "date,click to select",
  [K.ENUMERATION_VALUE]: "Enumeration Value ",
  [K.ENUM_REGEX_JSON]: "Enumeration Value/Regex Validation/JSON Schema",
