...
export const structsFormItemV2Story: Story = {
  storyId: "forms.general-structs-form-item-v2",
  category: "form-input-advanced",
  type: "brick",
  author: "william",
  text: {
    en: "Editable table v2",
    zh: "可编辑表格v2",
  },
  description: {
    en: "",
  ...
  conf: [
    {
      bricks: [
        {
          brick: "forms.general-structs-form-item-v2",
          properties: {
            label: "参数",
            btnText: "添加参数",
            structDefaultValues: {
      ...
      snippetId: "forms.general-structs-form-item-v2[basic]",
      title: {
